  ...
  <div>
    ...
    <nav id="sidebar">
      ...
      <ul>
        ...
        <li class="divider"></li>
        <li>
          <a href="@/assets/pages/tierlist.html" class="menu-link-flex">
            <span>Tier List</span>
        ...
        <li class="divider"></li>
        <li>
          <a href="@/assets/pages/resonadores.html" class="menu-link-flex">
            <span>Resonadores</span>
            <img src="@/assets/images/categorias/resonadores.webp" alt="Resonadores" class="menu-icon-img">
          </a>
        </li>
        <li>
          <a href="@/assets/pages/armas.html" class="menu-link-flex">
            <span>Armas</span>
    ...
    <div class="guide-header">
      <div class="guide-breadcrumbs">
        <router-link to="/">Wuthering Labs</router-link> / <span>Políticas de privacidad</span>
      </div>
      <div class="guide-header-main">
        <div class="intro-anim">
          <div class="guide-img-wrapper">
            <img src="@/assets/images/categorias/compass.webp" alt="Políticas de privacidad" class="guide-img default">
        ...
        <div class="guide-header-info">
          <h1 class="guide-header-title">Políticas de privacidad</h1>
          <div class="guide-header-desc">Políticas de privacidad de Wuthering Labs.</div>
    ...
    <section class="privacy-policy">
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Wuthering Labs, Buenos Aires.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to Wuthering Labs, accessible from <a href="wutheringlabs.com"
              rel="external nofollow noopener" target="_blank">wutheringlabs.com</a></p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: wutheringlabs@gmail.com</p>
        </li>
        <li>
          <p>By joining our discord server: <a href="https://discord.com/invite/3U7bmCyET5"
